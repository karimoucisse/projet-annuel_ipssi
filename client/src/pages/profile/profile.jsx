        ...
        <Box mt={4}>
          {isEditing ? (
            ...
            <div style={userInfoStyle}>
              ...
              <Typography style={infoStyle}>
                Nom de famille: {userInfo.lastname}
              </Typography>
              <Typography style={infoStyle}>
                Téléphone: {userInfo.phone}
              </Typography>
              <Typography style={infoStyle}>
                Type de voie: {userInfo.wayType}
              </Typography>
              <Typography style={infoStyle}>
                Numéro: {userInfo.number}
              </Typography>
              <Typography style={infoStyle}>
                Nom de l'adresse: {userInfo.addressName}
              </Typography>
              <Typography style={infoStyle}>
                Code postal: {userInfo.postalCode}
              </Typography>
