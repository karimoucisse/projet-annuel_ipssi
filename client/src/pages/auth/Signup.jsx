...
const Subscription = () => {
    ...
    const isStep1Valid = (data) => {
        if (!data.wayType || !data.number || !data.addressName || !data.postalCode || !data.state || !data.city || !data.country) {
            return false;
        }
        return true;
    };
    ...
    const onSubmit = async (e) => {
        ...
        if (isStep0Valid(userInfo) && isStep1Valid(userInfo) && isStep2Valid(userInfo)) {
